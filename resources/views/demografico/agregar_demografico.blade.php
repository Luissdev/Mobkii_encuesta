	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				<div class="panel-heading">Agregar demografico</div>
				<div class="panel-body">
					...
					<form class="form-horizontal margen" role="form" method="POST" action="{{ url('/auth/demografico/agregar-demografico') }}">
